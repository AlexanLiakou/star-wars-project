...
const CharacterDetailsPage = () => {
    ...
    <section>
        ...
        <div className='border border-star-mustard rounded-md p-8 my-10 grid grid-cols-1 md:grid-cols-2'>
            <div className='grow flex flex-col gap-4 items-center justify-center mb-10'>
            ...
            <div className='mb-10'>
                <h2 className="text-star-creme text-xl md:text-3xl font-bold text-center mb-4">Films</h2>
            ...
            <div className='mb-10'>
                <h2 className="text-star-creme text-xl md:text-3xl font-bold text-center mb-4">Starships</h2>
                <div className='grow flex flex-col gap-4 items-center justify-center'>
            ...
            <div className='mb-10'>
                <h2 className="text-star-creme text-xl md:text-3xl font-bold text-center mb-4">Vehicles</h2>
                <div className='grow flex flex-col gap-4 items-center justify-center'>
                    {relations.vehicles.isLoading ? (
                            <p className="text-star-yellow text-xl font-bold italic mt-5">Loading...</p>
                        ) : relations.vehicles.isError ? (
                            <p className="text-star-yellow text-xl font-bold i className='mb-4'talic mt-5">Failed to load vehicles</p>
